...
function LoFiBackground() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      >
        <defs>
          <radialGradient id="ss-lamp-glow-login" cx="0.5" cy="0.5" r="0.5">
        ...
        <div className="rounded-2xl border border-[#3A2C22]/70 bg-[#1D1611]/85 p-7 shadow-[0_24px_60px_-15px_rgba(0,0,0,0.65)] backdrop-blur-sm">
          ...
          >
            ...
            <div className="-mt-1 flex justify-end">
              <button
                type="button"
                className="text-[12.5px] text-[#8A7B6C] transition-colors duration-200 hover:text-[#E3A567]"
              >
                Forgot password?
              </button>
            </div>
